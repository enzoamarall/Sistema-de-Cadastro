<?php 
   ...
   $stmt = $conn->prepare("INSERT INTO graphicprocessadorenzomiguel (yearenzomiguel, valueenzomiguel) VALUES(:YEARENZOMIGUEL,:VALUEENZOMIGUEL)");
   ...
   $stmt->execute();
   header("Location: listProcessador.php");
?>