    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Ano',  'Valor de compra dos Carros'],
         <?php
         require_once "conn.php";

         $query = "SELECT * FROM graphiccarroenzomiguel";
        ...
        var options = {
          title: 'Salarios-minimos necessarios para compra de um carro popular',
          curveType: 'function',
...
<div class="container mt-3" style="position: absolute; left: 100px;top: 670px;">
    <button style="background-color: ciano; border-color: ciano;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminPanelModal" onclick="window.location.href = 'listCarro.php';">Painel ADM Carro</button>
    <button style="background-color: green; border-color: green" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerValueModal" onclick="window.location.href = 'cadastroCarro.php';">Cadastrar valor Carrro</button>
