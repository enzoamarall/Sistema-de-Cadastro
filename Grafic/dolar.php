    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Ano',  'Valor de Compra do Dolar'],
         <?php
         require_once "conn.php";

         $query = "SELECT * FROM graphicdolarenzomiguel";
        ...
        var options = {
          title: 'poder de compra (Dolares por salario-minimo)',
          curveType: 'function',
...
<div class="container mt-3" style="position: absolute; left: 100px;top: 670px;">
    <button style="background-color: ciano; border-color: ciano;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminPanelModal" onclick="window.location.href = 'listDolar.php';">Painel ADM Dolar</button>
    <button style="background-color: green; border-color: green" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerValueModal" onclick="window.location.href = 'cadastroDolar.php';">Cadastrar valor Dolar</button>
