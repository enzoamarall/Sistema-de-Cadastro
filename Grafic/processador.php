    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
         ...
         $query = "SELECT * FROM graphicprocessadorenzomiguel";
        ...
        var options = {
          chart: {
            title: '1° 2014 - Sem taxa | 2°  2014 - Com taxa | 3° 2022 - Sem taxa',
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    ...
    <div id="columnchart_material" style="width: 900px; height: 500px; position: absolute; 
...
<div class="container mt-3" style="position: absolute; left: 100px;top: 670px;">
    <button style="background-color: ciano; border-color: ciano;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminPanelModal" onclick="window.location.href = 'listProcessador.php';">Painel ADM Processador</button>
    <button style="background-color: green; border-color: green" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerValueModal" onclick="window.location.href = 'cadastroProcessador.php';">Cadastrar valor Processador</button>
