    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
         ...
         $query = "SELECT * FROM graphicgasolinaenzomiguel";
        ...
        var options = {
          title: 'poder de compra (Gasolina em Litro)',
          curveType: 'function',
...
<div class="container mt-3" style="position: absolute; left: 100px;top: 670px;">
    <button style="background-color: ciano; border-color: ciano;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminPanelModal" onclick="window.location.href = 'listGasolina.php';">Painel ADM Gasolina</button>
    <button style="background-color: green; border-color: green" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerValueModal" onclick="window.location.href = 'cadastro.php';">Cadastrar valor Gasolina</button>
