<?php 
    ...
    $stmt = $conn->prepare("UPDATE  graphicprocessadorenzomiguel SET yearenzomiguel = :YEARENZOMIGUEL, valueenzomiguel = :VALUEENZOMIGUEL WHERE idenzomiguel = :IDENZOMIGUEL");
    ...
    $stmt->execute();
    header("Location: processador.php");
 ?>
