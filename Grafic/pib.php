    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Ano',  'PIB Brasileiro(em trilhoes USD)'],
         <?php
         require_once "conn.php";

         $query = "SELECT * FROM graphicpibenzomiguel";
        ...
        var options = {
          title:  'PIB Brasileiro(em trilhoes USD)',
          curveType: 'function',
...
<div class="container mt-3" style="position: absolute; left: 100px;top: 670px;">
    <button style="background-color: ciano; border-color: ciano;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adminPanelModal" onclick="window.location.href = 'listPib.php';">Painel ADM PIB</button>
    <button style="background-color: green; border-color: green" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerValueModal" onclick="window.location.href = 'cadastroPib.php';">Cadastrar valor PIB</button>
