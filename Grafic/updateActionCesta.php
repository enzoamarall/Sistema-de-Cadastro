<?php 
    ...
    $stmt = $conn->prepare("UPDATE graphiccestabasicaenzomiguel  SET yearenzomiguel = :YEARENZOMIGUEL, valueenzomiguel = :VALUEENZOMIGUEL WHERE idenzomiguel = :IDENZOMIGUEL");
